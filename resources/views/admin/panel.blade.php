        ...
        <div class="mx-auto max-w-7xl border-gray-400 grid grid-cols-4 gap-3 grid-rows-1 my-3 ">
            <div class="max-w-xl col-span-1  ">
                ...
                <div class="bg-white rounded-lg btn-container shadow-lg flex-col">
                    ...
                    <a class="btn shadow-lg ml-5 mb-5 text-center rounded-lg inline-flex bg-indigo-600 text-white" style="padding: 8px 48px;" href="{{route('admin.destroy')}}">Очистити базу новин</a>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <table class="text-sm text-left text-gray-500 dark:text-gray-400 dataTable mx-auto bg-gray-100 border-gray-100 rounded-lg" style="max-width: 940px">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Джерело</th>
                            <th scope="col" class="px-6 py-3">Дата публікації</th>
                            <th scope="col" class="px-3 py-3">Дії</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($news as $new)
